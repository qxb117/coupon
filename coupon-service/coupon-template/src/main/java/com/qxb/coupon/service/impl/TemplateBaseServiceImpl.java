...
public class TemplateBaseServiceImpl implements ITemplateBaseService {
    ...
    public List<CouponTemplateSDK> findAllUsableTemplate() {
        List<CouponTemplate> template = templateDao.findAllByAvaillableAndExpired(true,false);
        return template.stream().map(this::template2TemplateSDK).collect(Collectors.toList());
    }
